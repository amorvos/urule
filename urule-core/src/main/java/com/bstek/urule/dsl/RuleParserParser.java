...
public class RuleParserParser extends Parser {
    ...
    public static class RuleSetContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRuleSet(this);
    ...
    public static class RuleSetHeaderContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_ruleSetHeader;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRuleSetHeader(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RuleSetBodyContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_ruleSetBody;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRuleSetBody(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RulesContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRules(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionImportContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_functionImport;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitFunctionImport(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PackageDefContext extends ParserRuleContext {
        public List<TerminalNode> Identifier() {
            return getTokens(RuleParserParser.Identifier);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_packageDef;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitPackageDef(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ResourceContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitResource(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ImportParameterLibraryContext extends ParserRuleContext {
        public TerminalNode STRING() {
            return getToken(RuleParserParser.STRING, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_importParameterLibrary;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitImportParameterLibrary(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ImportVariableLibraryContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_importVariableLibrary;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitImportVariableLibrary(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ImportConstantLibraryContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_importConstantLibrary;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitImportConstantLibrary(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ImportActionLibraryContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_importActionLibrary;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitImportActionLibrary(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionDefContext extends ParserRuleContext {
        public TerminalNode Identifier() {
            return getToken(RuleParserParser.Identifier, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitFunctionDef(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionParametersContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitFunctionParameters(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionParameterContext extends ParserRuleContext {
        public TerminalNode Datatype() {
            return getToken(RuleParserParser.Datatype, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitFunctionParameter(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RuleDefContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRuleDef(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LoopRuleDefContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_loopRuleDef;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitLoopRuleDef(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LoopTargetContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_loopTarget;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitLoopTarget(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LoopStartContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_loopStart;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitLoopStart(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LoopEndContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitLoopEnd(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AttributeContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LoopAttributeContext extends ParserRuleContext {
        public TerminalNode Boolean() {
            return getToken(RuleParserParser.Boolean, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_loopAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitLoopAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SalienceAttributeContext extends ParserRuleContext {
        public TerminalNode NUMBER() {
            return getToken(RuleParserParser.NUMBER, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_salienceAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitSalienceAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class EffectiveDateAttributeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_effectiveDateAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitEffectiveDateAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpiresDateAttributeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_expiresDateAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitExpiresDateAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class EnabledAttributeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_enabledAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitEnabledAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DebugAttributeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_debugAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitDebugAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ActivationGroupAttributeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_activationGroupAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitActivationGroupAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AgendaGroupAttributeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_agendaGroupAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitAgendaGroupAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AutoFocusAttributeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_autoFocusAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitAutoFocusAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RuleflowGroupAttributeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_ruleflowGroupAttribute;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRuleflowGroupAttribute(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParenConditionsContext extends ConditionContext {
        ...
        public ParenConditionsContext(ConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitParenConditions(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MultiConditionsContext extends ConditionContext {
        ...
        public MultiConditionsContext(ConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitMultiConditions(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SingleConditionContext extends ConditionContext {
        ...
        public SingleConditionContext(ConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitSingleCondition(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SingleNamedConditionSetContext extends ConditionContext {
        ...
        public SingleNamedConditionSetContext(ConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitSingleNamedConditionSet(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NamedConditionSetContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_namedConditionSet;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitNamedConditionSet(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParenNamedConditionsContext extends NamedConditionContext {
        ...
        public ParenNamedConditionsContext(NamedConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitParenNamedConditions(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MultiNamedConditionsContext extends NamedConditionContext {
        ...
        public MultiNamedConditionsContext(NamedConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitMultiNamedConditions(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SingleNamedConditionsContext extends NamedConditionContext {
        ...
        public SingleNamedConditionsContext(NamedConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitSingleNamedConditions(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DecisionTableCellConditionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_decisionTableCellCondition;
        }
    ...
    public static class SingleCellConditionContext extends DecisionTableCellConditionContext {
        ...
        public SingleCellConditionContext(DecisionTableCellConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitSingleCellCondition(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MultiCellConditionsContext extends DecisionTableCellConditionContext {
        ...
        public MultiCellConditionsContext(DecisionTableCellConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitMultiCellConditions(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParenCellConditionsContext extends DecisionTableCellConditionContext {
        ...
        public ParenCellConditionsContext(DecisionTableCellConditionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitParenCellConditions(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RefNameContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRefName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RefObjectContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_refObject;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRefObject(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NullValueContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitNullValue(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ConditionLeftContext extends ParserRuleContext {
        ...
        public List<TerminalNode> ARITH() {
            return getTokens(RuleParserParser.ARITH);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_conditionLeft;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitConditionLeft(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpEvalContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitExpEval(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpAllContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitExpAll(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpExistsContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_expExists;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitExpExists(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpCollectContext extends ParserRuleContext {
        ...
        public TerminalNode COUNT() {
            return getToken(RuleParserParser.COUNT, 0);
        }
        ...
        public TerminalNode SUM() {
            return getToken(RuleParserParser.SUM, 0);
        }

        public TerminalNode AVG() {
            return getToken(RuleParserParser.AVG, 0);
        }

        public TerminalNode MAX() {
            return getToken(RuleParserParser.MAX, 0);
        }

        public TerminalNode MIN() {
            return getToken(RuleParserParser.MIN, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_expCollect;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitExpCollect(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class CommonFunctionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_commonFunction;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitCommonFunction(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExprConditionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_exprCondition;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitExprCondition(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpressionBodyContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_expressionBody;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitExpressionBody(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PercentContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitPercent(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LeftParenContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitLeftParen(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RightParenContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRightParen(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ColonContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitColon(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class JoinContext extends ParserRuleContext {
        public TerminalNode AND() {
            return getToken(RuleParserParser.AND, 0);
        }

        public TerminalNode OR() {
            return getToken(RuleParserParser.OR, 0);
        }
    ...
    public static class RightContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitRight(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class OtherContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitOther(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ActionsContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitActions(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ActionContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitAction(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AssignActionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_assignAction;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitAssignAction(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class OutActionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_outAction;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitOutAction(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MethodInvokeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_methodInvoke;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitMethodInvoke(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionInvokeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_functionInvoke;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitFunctionInvoke(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ActionParametersContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_actionParameters;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitActionParameters(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BeanMethodContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_beanMethod;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitBeanMethod(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ComplexValueContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_complexValue;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitComplexValue(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParameterContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitParameter(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParameterNameContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitParameterName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ConstantContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitConstant(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class VariableContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitVariable(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NamedVariableContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_namedVariable;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitNamedVariable(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PropertyContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitProperty(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class VariableCategoryContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_variableCategory;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitVariableCategory(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NamedVariableCategoryContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_namedVariableCategory;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitNamedVariableCategory(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ConstantCategoryContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_constantCategory;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitConstantCategory(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ValueContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof RuleParserVisitor)
                return ((RuleParserVisitor<? extends T>) visitor).visitValue(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class OpContext extends ParserRuleContext {
        public TerminalNode GreaterThen() {
            return getToken(RuleParserParser.GreaterThen, 0);
        }

        public TerminalNode GreaterThenOrEquals() {
            return getToken(RuleParserParser.GreaterThenOrEquals, 0);
        }

        public TerminalNode LessThen() {
            return getToken(RuleParserParser.LessThen, 0);
        }

        public TerminalNode LessThenOrEquals() {
            return getToken(RuleParserParser.LessThenOrEquals, 0);
        }

        public TerminalNode Equals() {
            return getToken(RuleParserParser.Equals, 0);
        }

        public TerminalNode NotEquals() {
            return getToken(RuleParserParser.NotEquals, 0);
        }

        public TerminalNode EndWith() {
            return getToken(RuleParserParser.EndWith, 0);
        }

        public TerminalNode NotEndWith() {
            return getToken(RuleParserParser.NotEndWith, 0);
        }

        public TerminalNode StartWith() {
            return getToken(RuleParserParser.StartWith, 0);
        }

        public TerminalNode NotStartWith() {
            return getToken(RuleParserParser.NotStartWith, 0);
        }

        public TerminalNode In() {
            return getToken(RuleParserParser.In, 0);
        }

        public TerminalNode NotIn() {
            return getToken(RuleParserParser.NotIn, 0);
        }

        public TerminalNode Match() {
            return getToken(RuleParserParser.Match, 0);
        }

        public TerminalNode NotMatch() {
            return getToken(RuleParserParser.NotMatch, 0);
        }

        public TerminalNode EqualsIgnoreCase() {
            return getToken(RuleParserParser.EqualsIgnoreCase, 0);
        }

        public TerminalNode NotEqualsIgnoreCase() {
            return getToken(RuleParserParser.NotEqualsIgnoreCase, 0);
        }

        public TerminalNode Contain() {
            return getToken(RuleParserParser.Contain, 0);
        }

        public TerminalNode NotContain() {
            return getToken(RuleParserParser.NotContain, 0);
        }
