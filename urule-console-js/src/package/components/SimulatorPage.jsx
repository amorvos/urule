                ...
                <div style={{minHeight: '400px'}}>
                    <div style={{
                        ...
                        <div className="btn-group btn-group-sm" style={{margin: '2px'}}>
                            ...
                            }}><i className="glyphicon glyphicon-flash"></i> 测试决策包
                            </button>
                        </div>
                        <div className="btn-group btn-group-sm" style={{margin: '2px'}}>
                            ...
                            }}><i className="glyphicon glyphicon-random"></i> 测试决策流
                            </button>
                        </div>
                        <div className="btn-group btn-group-sm" style={{margin: '2px'}}>
                    ...
                    <div className="row" style={{margin: 0}}>
                        ...
                        <div className="col-xs-9 col-md-9" style={{padding: 0}}>
                            <Grid headers={slaveHeaders} rows={this.state.simulatorCategoryRow.variables || []}
                                  uniqueKey={true}/>
                        </div>
                    </div>
                </div>
