            ...
            body = (
                <div className="row" style={{margin: 0}}>
                    ...
                    <div className="col-xs-10 col-md-10"
                         style={{padding: '5px', overflowX: 'scroll', border: 'solid 1px #eee'}}>
                        <div className="form-group">
                            ...
                            <div className="col-xs-2 col-md-2" style={{padding: '0px 10px 10px 15px'}}>
                                ...
                                }.bind(this)}><i className="glyphicon glyphicon-filter"></i> 过滤
                                </button>
                            </div>
                        </div>
                        <div style={{margin: '5px'}}>
                            <Grid uniqueKey={true} width={slaveTableWidth} headers={slaveHeaders}
                                  rows={slaveData.children || []}/>
                        </div>
                    </div>
                </div>
            );
