                    ...
                    <div>
                        <div style={{margin: '2px'}}>
                            <div className="btn-group btn-group-sm" style={{margin: '2px'}}>
                                ...
                                }}><i className="glyphicon glyphicon-plus-sign"></i> 添加Bean
                                </button>
                            </div>
                            <div className="btn-group btn-group-sm" style={{margin: '2px'}}>
                            ...
                            <div className="col-md-6 col-xs-6" style={{padding: '0px 4px 0px 2px'}}>
                                <div>
                                    <div className="btn-group btn-group-sm">
                                        ...
                                        }}><i className="glyphicon glyphicon-plus"></i> 添加方法
                                        </button>
                                    </div>
                                </div>
                                <Grid headers={slaveGridHeaders} rows={masterRowData.methods}
                                      operationConfig={slaveGridOperationCol} rowClick={(rowData, rowIndex) => {
                            ...
                            <div className="col-md-6 col-xs-6" style={{padding: '0px 2px 0px 1px'}}>
                                <div>
                                    <div className="btn-group btn-group-sm">
                                        ...
                                        }}><i className="glyphicon glyphicon-plus-sign"></i> 添加参数
                                        </button>
                                    </div>
                                </div>
